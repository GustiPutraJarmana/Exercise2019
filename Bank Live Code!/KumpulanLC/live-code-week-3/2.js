...
var age = 20; // silahkan beri nilai
var height = 125; // silahkan beri nilai
var accompaniedByAdult = 2; // silahkan beri nilai
if (money < 15000) {
  console.log("Maaf,uang kamu tidak cukup");
} else if (age < 7 || height < 125) {
  console.log("Kamu belum diperbolehkan untuk menaiki wahana ini");
} else if (age < 10 && accompaniedByAdult !== true) {
  console.log(
    "Kamu harus ditemani oleh orang dewasa untuk menikmati wahana ini"
  );
} else {
