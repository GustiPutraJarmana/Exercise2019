...
FUNCTION of getUglyNumber with parameter (num)
STORE 'result with [] / empaty squer bracket
FOR STORE 'i' with value 2; 'i' LESS EQUAL to 'num'; ADD 'i' by 1
  IF 'i' modulus 2 EQUAL to 0 or 'i' modulus 3 EQUAL to 0 or 'i' modulus 5 EQUAL to 0
    DO push 'i' to result
  ENDIF
ENDFOR
DISPLAY 'resut'!
